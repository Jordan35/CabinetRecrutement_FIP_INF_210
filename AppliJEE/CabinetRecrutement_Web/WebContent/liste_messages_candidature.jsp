...
//  IServiceOffreEmploi        serviceOffreEmploi        = (IServiceOffreEmploi) ServicesLocator.getInstance().getRemoteInterface("ServiceOffreEmploi");
    ...
    Candidature candidature = (Candidature) utilisateur;
	  %>
		...
		<table id="affichage">
		  ...
		  <%
		  for(MessageCandidature message : serviceCandidature.listeDesMessagesEnvoyes(candidature.getId()))
		  {
		    %>
		    <tr>
		     <td><%=message.getId()%></td>
    ...
    <table id="affichage">
      ...
      <%
      for(MessageCandidature message : serviceEntreprise.listeDesMessagesRecus(entreprise.getId()))
      {
        %>
        <tr>
         <td><%=message.getId()%></td>
